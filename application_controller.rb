...
The #{params[:adjective5]} doctor says that it will be #{params[:number]} weeks before
...
the time the tow #{params[:animal]} finnally arrived and the #{params[:past_tense_verb]}
